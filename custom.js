...
$(document).ready(function(){
	...
	$('.the-page').append('<div id="mySidenav" class="sidenav"><a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a><div class="row"><div class="col-12 user-dsk"><img src="img/user-dummy-pic.png" alt="" />	<a href="minha-conta.html">Entrar | Cadastre-se</a>	</div>	<div class="col-12 side-menu"><h3>MENU</h3>	<a href="inde.html"><i class="bx bx-home-alt" ></i> Home</a><a href="pedidos.html"><i class="bx bxs-package"></i> Meus Pedidos</a><a href="carrinho.html"><i class="bx bx-cart-alt" ></i> Carrinho</a>	<a href="favoritos.html"><i class="bx bx-heart" ></i> Favoritos</a><a href="categorias.html"><i class="bx bx-list-ul" ></i> Categorias</a><a href="promocoes.html"><i class="bx bxs-purchase-tag"></i> Promoções</a><a href="configuracoes.html"><i class="bx bx-cog" ></i> Configurações</a></div></div></div>');
